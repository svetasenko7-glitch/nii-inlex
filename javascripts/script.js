...
function intro() {
 document.addEventListener("DOMContentLoaded", () => {
      ...
      const USER_OPTIONS = {
        speedMin: 0.8,             // Минимальная скорость перемещения кубиков на десктопе
        speedMax: 3.0,             // Максимальная скорость перемещения кубиков на десктопе
        mobileSpeedMultiplier: 0.5, // Снижение скорости на мобильных экранах (чтобы не летали слишком быстро)
        spawnInterval: 1,       // Пауза между поочередным появлением кубиков на экране (в мс)
        imageFadeInterval: 50,   // Задержка перед тем, как на кубике начнет плавно проявляться картинка (в мс)
        moveStartInterval: 10,   // Пауза после появления картинки и перед началом движения кубика (в мс)
        imageFadeDuration: "1.2s"  // Плавность проявления картинки-иконки (значение для CSS transition)
      };

      const CONFIG = {
        cubeSizes: [
          { maxWidth: 480,   cubeWidth: 24 }, 
